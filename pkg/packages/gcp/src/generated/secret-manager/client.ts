...
export type secretmanagerProjectsSecretsListResponseError = (secretmanagerProjectsSecretsListResponseDefault) & {
  headers: Headers;
};

export type secretmanagerProjectsSecretsListResponse = (secretmanagerProjectsSecretsListResponseSuccess | secretmanagerProjectsSecretsListResponseError)

export const getSecretmanagerProjectsSecretsListUrl = (parent: string,
  ...
  return stringifiedParams.length > 0 ? `https://secretmanager.googleapis.com/v1/${parent}/secrets?${stringifiedParams}` : `https://secretmanager.googleapis.com/v1/${parent}/secrets`
}
...
export type secretmanagerProjectsSecretsCreateResponseError = (secretmanagerProjectsSecretsCreateResponseDefault) & {
  headers: Headers;
};

export type secretmanagerProjectsSecretsCreateResponse = (secretmanagerProjectsSecretsCreateResponseSuccess | secretmanagerProjectsSecretsCreateResponseError)

export const getSecretmanagerProjectsSecretsCreateUrl = (parent: string,
...
export type secretmanagerProjectsSecretsAddVersionResponseError = (secretmanagerProjectsSecretsAddVersionResponseDefault) & {
  headers: Headers;
};

export type secretmanagerProjectsSecretsAddVersionResponse = (secretmanagerProjectsSecretsAddVersionResponseSuccess | secretmanagerProjectsSecretsAddVersionResponseError)
...
export type secretmanagerProjectsSecretsDeleteResponseError = (secretmanagerProjectsSecretsDeleteResponseDefault) & {
  headers: Headers;
};

export type secretmanagerProjectsSecretsDeleteResponse = (secretmanagerProjectsSecretsDeleteResponseSuccess | secretmanagerProjectsSecretsDeleteResponseError)

export const getSecretmanagerProjectsSecretsDeleteUrl = (name: string,
  ...
  return stringifiedParams.length > 0 ? `https://secretmanager.googleapis.com/v1/${name}?${stringifiedParams}` : `https://secretmanager.googleapis.com/v1/${name}`
}
...
export type secretmanagerProjectsSecretsVersionsAccessResponseError = (secretmanagerProjectsSecretsVersionsAccessResponseDefault) & {
  headers: Headers;
};

export type secretmanagerProjectsSecretsVersionsAccessResponse = (secretmanagerProjectsSecretsVersionsAccessResponseSuccess | secretmanagerProjectsSecretsVersionsAccessResponseError)
