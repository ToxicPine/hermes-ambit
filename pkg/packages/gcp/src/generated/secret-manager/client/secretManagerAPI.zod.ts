 ...
 * Lists Secrets.
 */
export const secretmanagerProjectsSecretsListPathParentRegExp = new RegExp(
  "^projects\/[^\/]+$",
);
...
export const secretmanagerProjectsSecretsListParams = zod.object({
  parent: zod
    .string()
    .regex(secretmanagerProjectsSecretsListPathParentRegExp)
    .describe(
...
export const secretmanagerProjectsSecretsList200Response = zod
  .object({
    secrets: zod
      .array(
        zod
          .object({
                    ...
                    replicas: zod
                      .array(
                        zod
                          ...
                          .describe("Represents a Replica for this Secret."),
                      )
                      .optional()
                      .describe(
            ...
            ttl: zod
              .string()
              .optional()
              .describe("Input only. The TTL for the Secret."),
            etag: zod
              .string()
              .optional()
              .describe("Optional. Etag of the currently stored Secret."),
            rotation: zod
              .object({
                nextRotationTime: zod
                  .string()
                  .optional()
                  .describe(
...
export const secretmanagerProjectsSecretsListDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const secretmanagerProjectsSecretsCreatePathParentRegExp = new RegExp(
  "^projects\/[^\/]+$",
);
...
export const secretmanagerProjectsSecretsCreateParams = zod.object({
  parent: zod
    .string()
    .regex(secretmanagerProjectsSecretsCreatePathParentRegExp)
    .describe(
...
export const secretmanagerProjectsSecretsCreateBody = zod
  .object({
    replication: zod
      .object({
        automatic: zod
...
export const secretmanagerProjectsSecretsCreate200Response = zod
  .object({
    name: zod
      .string()
      .optional()
    ...
    createTime: zod
      .string()
      .optional()
      .describe("Output only. The time at which the Secret was created."),
    labels: zod
      .record(zod.string(), zod.string())
      .optional()
      .describe(
...
export const secretmanagerProjectsSecretsCreateDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const secretmanagerProjectsSecretsAddVersionPathParentRegExp =
  new RegExp("^projects\/[^\/]+\/secrets\/[^\/]+$");

export const secretmanagerProjectsSecretsAddVersionParams = zod.object({
  parent: zod
    .string()
    .regex(secretmanagerProjectsSecretsAddVersionPathParentRegExp)
    .describe(
...
export const secretmanagerProjectsSecretsAddVersionBody = zod
  .object({
    payload: zod
      .object({
        data: zod
          .string()
          .optional()
          .describe("The secret data. Must be no larger than 64KiB."),
        dataCrc32c: zod
          .string()
          .optional()
          .describe(
...
export const secretmanagerProjectsSecretsAddVersion200Response = zod
  .object({
    name: zod
      .string()
      .optional()
    ...
    state: zod
      ...
      .optional()
      .describe("Output only. The current state of the SecretVersion."),
    replicationStatus: zod
      .object({
        automatic: zod
          .object({
            customerManagedEncryption: zod
              .object({
                kmsKeyVersionName: zod
                  .string()
                  .optional()
                  .describe(
              ...
              .optional()
              .describe("Describes the status of customer-managed encryption."),
          })
          .optional()
          .describe(
      ...
      .optional()
      .describe("The replication status of a SecretVersion."),
    etag: zod
      .string()
      .optional()
      .describe("Output only. Etag of the currently stored SecretVersion."),
    clientSpecifiedPayloadChecksum: zod
      .boolean()
      .optional()
      .describe(
...
export const secretmanagerProjectsSecretsAddVersionDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 * Deletes a Secret.
 */
export const secretmanagerProjectsSecretsDeletePathNameRegExp = new RegExp(
  "^projects\/[^\/]+\/secrets\/[^\/]+$",
);
...
export const secretmanagerProjectsSecretsDeleteParams = zod.object({
  name: zod
    .string()
    .regex(secretmanagerProjectsSecretsDeletePathNameRegExp)
    .describe(
...
export const secretmanagerProjectsSecretsDelete200Response = zod
  .object({})
  .describe(
    "A generic empty message that you can re-use to avoid defining duplicated empty messages in your APIs. A typical example is to use it as the request or the response type of an API method. For instance: service Foo { rpc Bar(google.protobuf.Empty) returns (google.protobuf.Empty); }",
  );

export const secretmanagerProjectsSecretsDeleteDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const secretmanagerProjectsSecretsVersionsAccessPathNameRegExp =
  new RegExp("^projects\/[^\/]+\/secrets\/[^\/]+\/versions\/[^\/]+$");

export const secretmanagerProjectsSecretsVersionsAccessParams = zod.object({
  name: zod
    .string()
    .regex(secretmanagerProjectsSecretsVersionsAccessPathNameRegExp)
    .describe(
...
export const secretmanagerProjectsSecretsVersionsAccess200Response = zod
  .object({
    name: zod
      .string()
      .optional()
...
export const secretmanagerProjectsSecretsVersionsAccessDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
