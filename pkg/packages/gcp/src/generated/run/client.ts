...
export type runProjectsLocationsOperationsListResponseError = (runProjectsLocationsOperationsListResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsOperationsListResponse = (runProjectsLocationsOperationsListResponseSuccess | runProjectsLocationsOperationsListResponseError)

export const getRunProjectsLocationsOperationsListUrl = (name: string,
  ...
  return stringifiedParams.length > 0 ? `https://run.googleapis.com/v2/${name}/operations?${stringifiedParams}` : `https://run.googleapis.com/v2/${name}/operations`
}
...
export type runProjectsLocationsServicesGetResponseError = (runProjectsLocationsServicesGetResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsServicesGetResponse = (runProjectsLocationsServicesGetResponseSuccess | runProjectsLocationsServicesGetResponseError)
...
export type runProjectsLocationsServicesDeleteResponseError = (runProjectsLocationsServicesDeleteResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsServicesDeleteResponse = (runProjectsLocationsServicesDeleteResponseSuccess | runProjectsLocationsServicesDeleteResponseError)

export const getRunProjectsLocationsServicesDeleteUrl = (name: string,
...
export type runProjectsLocationsServicesPatchResponseError = (runProjectsLocationsServicesPatchResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsServicesPatchResponse = (runProjectsLocationsServicesPatchResponseSuccess | runProjectsLocationsServicesPatchResponseError)

export const getRunProjectsLocationsServicesPatchUrl = (name: string,
...
export type runProjectsLocationsOperationsWaitResponseError = (runProjectsLocationsOperationsWaitResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsOperationsWaitResponse = (runProjectsLocationsOperationsWaitResponseSuccess | runProjectsLocationsOperationsWaitResponseError)
...
export type runProjectsLocationsServicesCreateResponseError = (runProjectsLocationsServicesCreateResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsServicesCreateResponse = (runProjectsLocationsServicesCreateResponseSuccess | runProjectsLocationsServicesCreateResponseError)

export const getRunProjectsLocationsServicesCreateUrl = (parent: string,
  ...
  return stringifiedParams.length > 0 ? `https://run.googleapis.com/v2/${parent}/services?${stringifiedParams}` : `https://run.googleapis.com/v2/${parent}/services`
}
...
export type runProjectsLocationsServicesListResponseError = (runProjectsLocationsServicesListResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsServicesListResponse = (runProjectsLocationsServicesListResponseSuccess | runProjectsLocationsServicesListResponseError)

export const getRunProjectsLocationsServicesListUrl = (parent: string,
...
export type runProjectsLocationsServicesGetIamPolicyResponseError = (runProjectsLocationsServicesGetIamPolicyResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsServicesGetIamPolicyResponse = (runProjectsLocationsServicesGetIamPolicyResponseSuccess | runProjectsLocationsServicesGetIamPolicyResponseError)

export const getRunProjectsLocationsServicesGetIamPolicyUrl = (resource: string,
  ...
  return stringifiedParams.length > 0 ? `https://run.googleapis.com/v2/${resource}:getIamPolicy?${stringifiedParams}` : `https://run.googleapis.com/v2/${resource}:getIamPolicy`
}
...
export type runProjectsLocationsServicesSetIamPolicyResponseError = (runProjectsLocationsServicesSetIamPolicyResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsServicesSetIamPolicyResponse = (runProjectsLocationsServicesSetIamPolicyResponseSuccess | runProjectsLocationsServicesSetIamPolicyResponseError)
...
export type runProjectsLocationsServicesTestIamPermissionsResponseError = (runProjectsLocationsServicesTestIamPermissionsResponseDefault) & {
  headers: Headers;
};

export type runProjectsLocationsServicesTestIamPermissionsResponse = (runProjectsLocationsServicesTestIamPermissionsResponseSuccess | runProjectsLocationsServicesTestIamPermissionsResponseError)
