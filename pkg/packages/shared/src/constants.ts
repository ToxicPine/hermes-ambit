...
export const isUniversalHermesImageConfigured = (
  ...
  return value.length > 0 && !value.toUpperCase().startsWith("TODO");
};
...
export const HERMES_HOME_MANAGER_READ_COMMAND =
  `${HERMES_APP_PREFIX_PATH}/bin/read-managed-hm`;
export const HERMES_HOME_MANAGER_WRITE_COMMAND =
  `${HERMES_APP_PREFIX_PATH}/bin/write-managed-hm`;
