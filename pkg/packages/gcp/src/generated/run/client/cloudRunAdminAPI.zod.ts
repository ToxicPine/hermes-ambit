 ...
 */
export const runProjectsLocationsOperationsListPathNameRegExp = new RegExp(
  "^projects\/[^\/]+\/locations\/[^\/]+$",
);
...
export const runProjectsLocationsOperationsListParams = zod.object({
  name: zod
    .string()
    .regex(runProjectsLocationsOperationsListPathNameRegExp)
    .describe("Required. To query for all of the operations for a project."),
});
...
export const runProjectsLocationsOperationsList200Response = zod
  .object({
    operations: zod
      .array(
        zod
    ...
    nextPageToken: zod
      .string()
      .optional()
      .describe("The standard List next-page token."),
    unreachable: zod
      .array(zod.string())
      .optional()
      .describe(
...
export const runProjectsLocationsOperationsListDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const runProjectsLocationsServicesGetPathNameRegExp = new RegExp(
...
export const runProjectsLocationsServicesGetParams = zod.object({
  name: zod
    .string()
    .regex(runProjectsLocationsServicesGetPathNameRegExp)
    .describe(
...
export const runProjectsLocationsServicesGet200Response = zod
  .object({
    name: zod
      .string()
      .optional()
    ...
    template: zod
      .object({
        ...
        scaling: zod
          ...
          .optional()
          .describe("Settings for revision-level scaling settings."),
        vpcAccess: zod
          .object({
            connector: zod
              .string()
                    ...
                    cloudStorageSource: zod
                      .object({
                        bucket: zod
                          .string()
                          .optional()
                          .describe("Required. The Cloud Storage bucket name."),
                        object: zod
                          .string()
                          .optional()
                          .describe("Required. The Cloud Storage object name."),
                        generation: zod
                          .string()
                          .optional()
                          .describe(
                    ...
                    inlinedSource: zod
                      .object({
                        sources: zod
                          ...
                          .optional()
                          .describe("Required. Input only. The source code."),
                      })
                      .optional()
                            ...
                            zod
                              .object({
                                name: zod
                                  .string()
                                  .optional()
                                  .describe("Required. The header field name"),
                                value: zod
                                  .string()
                                  .optional()
                                  .describe("Optional. The header field value"),
                              })
                              .describe(
        ...
        maxInstanceRequestConcurrency: zod
          .number()
          .optional()
          .describe(
        ...
        encryptionKeyRevocationAction: zod
          .enum([
        ...
        encryptionKeyShutdownDuration: zod
          .string()
          .optional()
          .describe(
        ...
        sessionAffinity: zod
          .boolean()
          .optional()
          .describe("Optional. Enable session affinity."),
        healthCheckDisabled: zod
          .boolean()
          .optional()
          .describe(
        ...
        zod
          .object({
            type: zod
              ...
              .optional()
              .describe("The allocation type for this traffic target."),
            revision: zod
              .string()
              .optional()
              .describe(
    ...
    scaling: zod
      .object({
        ...
        scalingMode: zod
          ...
          .optional()
          .describe("Optional. The scaling mode for the service."),
        maxInstanceCount: zod
          .number()
          .optional()
          .describe(
    ...
    urls: zod
      .array(zod.string())
      .optional()
      .describe("Output only. All URLs serving traffic for this Service."),
    iapEnabled: zod
      .boolean()
      .optional()
      .describe("Optional. IAP settings on the Service."),
    multiRegionSettings: zod
      .object({
        regions: zod
          .array(zod.string())
          .optional()
      ...
      .optional()
      .describe("Settings for multi-region deployment."),
    customAudiences: zod
      .array(zod.string())
      .optional()
      .describe(
    ...
    latestReadyRevision: zod
      .string()
      .optional()
      .describe(
        "Output only. Name of the latest revision that is serving traffic. See comments in `reconciling` for additional information on reconciliation process in Cloud Run.",
      ),
    latestCreatedRevision: zod
      .string()
      .optional()
      .describe(
        ...
        zod
          .object({
            ...
            revision: zod
              .string()
              .optional()
              .describe("Revision to which this traffic is sent."),
            percent: zod
              .number()
              .optional()
              .describe("Specifies percent of the traffic to this Revision."),
            tag: zod
              .string()
              .optional()
              .describe(
    ...
    buildConfig: zod
      .object({
        ...
        baseImage: zod
          .string()
          .optional()
          .describe("Optional. The base image used to build the function."),
        enableAutomaticUpdates: zod
          .boolean()
          .optional()
          .describe(
...
export const runProjectsLocationsServicesGetDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const runProjectsLocationsServicesDeletePathNameRegExp = new RegExp(
  "^projects\/[^\/]+\/locations\/[^\/]+\/services\/[^\/]+$",
);
...
export const runProjectsLocationsServicesDeleteParams = zod.object({
  name: zod
    .string()
    .regex(runProjectsLocationsServicesDeletePathNameRegExp)
    .describe(
      "Required. The full name of the Service. Format: projects\/{project}\/locations\/{location}\/services\/{service}, where {project} can be project id or number.",
    ),
});
...
export const runProjectsLocationsServicesDelete200Response = zod
  .object({
    name: zod
      .string()
      .optional()
...
export const runProjectsLocationsServicesDeleteDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 * Updates a Service.
 */
export const runProjectsLocationsServicesPatchPathNameRegExp = new RegExp(
  "^projects\/[^\/]+\/locations\/[^\/]+\/services\/[^\/]+$",
);
...
export const runProjectsLocationsServicesPatchParams = zod.object({
  name: zod
    .string()
    .regex(runProjectsLocationsServicesPatchPathNameRegExp)
    .describe(
      "Identifier. The fully qualified name of this Service. In CreateServiceRequest, this field is ignored, and instead composed from CreateServiceRequest.parent and CreateServiceRequest.service_id. Format: projects\/{project}\/locations\/{location}\/services\/{service_id}",
    ),
});
...
export const runProjectsLocationsServicesPatchQueryParams = zod.object({
  updateMask: zod
    .string()
    .optional()
    .describe("Optional. The list of fields to be updated."),
  validateOnly: zod
    .boolean()
    .optional()
    .describe(
...
export const runProjectsLocationsServicesPatchBody = zod
  .object({
    name: zod
      .string()
      .optional()
...
export const runProjectsLocationsServicesPatch200Response = zod
  .object({
    name: zod
      .string()
      .optional()
...
export const runProjectsLocationsServicesPatchDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const runProjectsLocationsOperationsWaitPathNameRegExp = new RegExp(
...
export const runProjectsLocationsOperationsWaitParams = zod.object({
  name: zod
    .string()
    .regex(runProjectsLocationsOperationsWaitPathNameRegExp)
    .describe("The name of the operation resource to wait on."),
});

export const runProjectsLocationsOperationsWaitBody = zod
  .object({
    timeout: zod
      .string()
      .optional()
...
export const runProjectsLocationsOperationsWait200Response = zod
  .object({
    name: zod
      .string()
      .optional()
...
export const runProjectsLocationsOperationsWaitDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const runProjectsLocationsServicesCreatePathParentRegExp = new RegExp(
  "^projects\/[^\/]+\/locations\/[^\/]+$",
);
...
export const runProjectsLocationsServicesCreateParams = zod.object({
  parent: zod
    .string()
    .regex(runProjectsLocationsServicesCreatePathParentRegExp)
    .describe(
...
export const runProjectsLocationsServicesCreateBody = zod
  .object({
    name: zod
      .string()
      .optional()
...
export const runProjectsLocationsServicesCreate200Response = zod
  .object({
    name: zod
      .string()
      .optional()
...
export const runProjectsLocationsServicesCreateDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const runProjectsLocationsServicesListPathParentRegExp = new RegExp(
  "^projects\/[^\/]+\/locations\/[^\/]+$",
);
...
export const runProjectsLocationsServicesListParams = zod.object({
  parent: zod
    .string()
    .regex(runProjectsLocationsServicesListPathParentRegExp)
    .describe(
...
export const runProjectsLocationsServicesListQueryParams = zod.object({
  pageSize: zod
    .number()
    .optional()
    .describe("Maximum number of Services to return in this call."),
  pageToken: zod
    .string()
    .optional()
    .describe(
...
export const runProjectsLocationsServicesList200Response = zod
  .object({
    services: zod
      .array(
        zod
                ...
                zod
                  .object({
                    ...
                    uri: zod
                      .string()
                      .optional()
                      .describe("Displays the target URI."),
                  })
                  .describe(
                    "Represents the observed state of a single `TrafficTarget` entry.",
                  ),
      ...
      .optional()
      .describe("The resulting list of Services."),
    nextPageToken: zod
      .string()
      .optional()
      .describe(
...
export const runProjectsLocationsServicesListDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const runProjectsLocationsServicesGetIamPolicyPathResourceRegExp =
  new RegExp("^projects\/[^\/]+\/locations\/[^\/]+\/services\/[^\/]+$");

export const runProjectsLocationsServicesGetIamPolicyParams = zod.object({
  resource: zod
    .string()
    .regex(runProjectsLocationsServicesGetIamPolicyPathResourceRegExp)
    .describe(
...
export const runProjectsLocationsServicesGetIamPolicyQueryParams = zod.object({
  "options.requestedPolicyVersion": zod
    .number()
    .optional()
    .describe(
...
export const runProjectsLocationsServicesGetIamPolicy200Response = zod
  .object({
    version: zod
      .number()
      .optional()
    ...
    bindings: zod
      .array(
        zod
          ...
          .describe("Associates `members`, or principals, with a `role`."),
      )
      .optional()
      .describe(
...
export const runProjectsLocationsServicesGetIamPolicyDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const runProjectsLocationsServicesSetIamPolicyPathResourceRegExp =
  new RegExp("^projects\/[^\/]+\/locations\/[^\/]+\/services\/[^\/]+$");

export const runProjectsLocationsServicesSetIamPolicyParams = zod.object({
  resource: zod
    .string()
    .regex(runProjectsLocationsServicesSetIamPolicyPathResourceRegExp)
    .describe(
      "REQUIRED: The resource for which the policy is being specified. See [Resource names](https:\/\/cloud.google.com\/apis\/design\/resource_names) for the appropriate value for this field.",
    ),
});

export const runProjectsLocationsServicesSetIamPolicyBody = zod
  .object({
    policy: zod
      .object({
        version: zod
...
export const runProjectsLocationsServicesSetIamPolicy200Response = zod
  .object({
    version: zod
      .number()
      .optional()
...
export const runProjectsLocationsServicesSetIamPolicyDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
 ...
 */
export const runProjectsLocationsServicesTestIamPermissionsPathResourceRegExp =
  new RegExp("^projects\/[^\/]+\/locations\/[^\/]+\/services\/[^\/]+$");

export const runProjectsLocationsServicesTestIamPermissionsParams = zod.object({
  resource: zod
    .string()
    .regex(runProjectsLocationsServicesTestIamPermissionsPathResourceRegExp)
    .describe(
      "REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https:\/\/cloud.google.com\/apis\/design\/resource_names) for the appropriate value for this field.",
    ),
});

export const runProjectsLocationsServicesTestIamPermissionsBody = zod
  .object({
    permissions: zod
      .array(zod.string())
      .optional()
...
export const runProjectsLocationsServicesTestIamPermissions200Response = zod
  .object({
    permissions: zod
      .array(zod.string())
      .optional()
...
export const runProjectsLocationsServicesTestIamPermissionsDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
