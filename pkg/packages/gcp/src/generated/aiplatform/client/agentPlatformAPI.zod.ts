 ...
 */
export const aiplatformPublishersModelsListPathParentRegExp = new RegExp(
  "^publishers\/[^\/]+$",
);
...
export const aiplatformPublishersModelsListParams = zod.object({
  parent: zod
    .string()
    .regex(aiplatformPublishersModelsListPathParentRegExp)
    .describe(
...
export const aiplatformPublishersModelsListQueryParams = zod.object({
  filter: zod
    .string()
    .optional()
    .describe("Optional. The standard list filter."),
  pageSize: zod
    .number()
    .optional()
    .describe("Optional. The standard list page size."),
  pageToken: zod
    .string()
    .optional()
    .describe(
  ...
  view: zod
    ...
    .optional()
    .describe("Optional. PublisherModel view specifying which fields to read."),
  orderBy: zod
    .string()
    .optional()
    .describe(
...
export const aiplatformPublishersModelsList200Response = zod
  .object({
    publisherModels: zod
      .array(
        zod
          .object({
                ...
                reference: zod
                  .object({
                    ...
                    useCase: zod
                      .string()
                      .optional()
                      .describe("Use case (CUJ) of the resource."),
                    description: zod
                      .string()
                      .optional()
                  ...
                  .optional()
                  .describe("Reference to a resource."),
              })
              .optional()
              .describe("The information about the parent of a model."),
            supportedActions: zod
              .object({
                viewRestApi: zod
                  .object({
                    documentations: zod
                      .array(
                        zod
                          ...
                          .describe("A named piece of documentation."),
                      )
                      .optional()
                      .describe("Required."),
                    title: zod
                      .string()
                      .optional()
                      .describe("Required. The title of the view rest API."),
                  })
                  .optional()
                ...
                openNotebook: zod
                  .object({
                    ...
                    resourceTitle: zod
                      .string()
                      .optional()
                      .describe("Optional. Title of the resource."),
                    resourceUseCase: zod
                      .string()
                      .optional()
                      .describe("Optional. Use case (CUJ) of the resource."),
                    resourceDescription: zod
                      .string()
                      .optional()
                      .describe("Optional. Description of the resource."),
                    supportsWorkbench: zod
                      .boolean()
                      .optional()
                      .describe(
                        "Optional. For notebook resource, whether the notebook supports Workbench.",
                      ),
                    colabNotebookDisabled: zod
                      .boolean()
                      .optional()
                      .describe(
                ...
                openNotebooks: zod
                  ...
                  .optional()
                  .describe("Open notebooks."),
                createApplication: zod
                  .object({
                    references: zod
                      .record(
                        zod.string(),
                ...
                openFineTuningPipelines: zod
                  .object({
                    fineTuningPipelines: zod
                      .array(
                        zod
                          .object({
                            references: zod
                  ...
                  .optional()
                  .describe("Open fine tuning pipelines."),
                openPromptTuningPipeline: zod
                  .object({
                    references: zod
                      .record(
                        zod.string(),
                ...
                deploy: zod
                  .object({
                    dedicatedResources: zod
                      .object({
                        machineSpec: zod
                          ...
                          .optional()
                          .describe("Specification of a single machine."),
                        minReplicaCount: zod
                          .number()
                          .optional()
                          .describe(
                        ...
                        scaleToZeroSpec: zod
                          ...
                          .optional()
                          .describe("Specification for scale-to-zero feature."),
                      })
                      .optional()
                      .describe(
                    ...
                    modelDisplayName: zod
                      .string()
                      .optional()
                      .describe("Optional. Default model display name."),
                    largeModelReference: zod
                      .object({
                        name: zod
                          .string()
                          .optional()
                      ...
                      .optional()
                      .describe("Contains information about the Large Model."),
                    containerSpec: zod
                      .object({
                        imageUri: zod
                          .string()
                                    ...
                                    zod
                                      .object({
                                        ...
                                        value: zod
                                          .string()
                                          .optional()
                                          .describe("The header field value"),
                                      })
                                      .describe(
                ...
                multiDeployVertex: zod
                  ...
                  .optional()
                  .describe("Multiple setups to deploy the PublisherModel."),
                deployGke: zod
                  .object({
                    gkeYamlConfigs: zod
                      .array(zod.string())
                  ...
                  .optional()
                  .describe("Configurations for PublisherModel GKE deployment"),
                openGenerationAiStudio: zod
                  .object({
                    references: zod
                      .record(
                        zod.string(),
              ...
              .optional()
              .describe("Actions could take on this Publisher Model."),
            frameworks: zod
              .array(zod.string())
              .optional()
              .describe(
            ...
            launchStage: zod
              ...
              .optional()
              .describe("Optional. Indicates the launch stage of the model."),
            versionState: zod
              .enum([
              ...
              .optional()
              .describe("Optional. Indicates the state of the model version."),
            publisherModelTemplate: zod
              .string()
              .optional()
              .describe(
          ...
          .describe("A Model Garden Publisher Model."),
      )
      .optional()
      .describe("List of PublisherModels in the requested page."),
    nextPageToken: zod
      .string()
      .optional()
      .describe(
...
export const aiplatformPublishersModelsListDefaultResponse = zod
  .object({
    code: zod
      .number()
      .optional()
